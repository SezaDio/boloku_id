                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
									<div style="margin-top:10px; margin-bottom:30px">
                                        ...
                                        <?php }?>
										<a href="<?php echo site_url('KelolaArtikel/tambah_artikel_check/');?>">
                                            <button type="submit" name="submit" class="btn btn-info"><i class="glyphicon glyphicon-plus" ></i> Tambah Artikel</button>
                                        </a>
									</div>
                                                    ...
                                                    { ?>
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <!-- Tombol Hapus -->
                                                                <button onclick="delete_artikel_ajax(<?php echo $item['id_artikel']; ?>)" id="delete-button-wow" type="submit" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash" ></i> Hapus</button>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                            </tbody>
